...
contract Ownable {
    ...
    event newContractOwner(address newOwner);
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender == _tokenOwner[tokenId] || isApprovedForAll(_tokenOwner[tokenId],to));
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_exists(tokenId) != true || to != address(0));
